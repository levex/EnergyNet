...
contract Master {
    ...
    function sell(uint unitPrice, uint amountOffered, bool renewable) public returns(address) {
        // TODO: delegate call
        uint date = now;
        Energy energy = new Energy(msg.sender, unitPrice, amountOffered, date, renewable);
